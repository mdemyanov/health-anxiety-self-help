  ...
  steps: [
    ...
    },
    {
      ...
      messages: [
        ...
        {
          type: 'therapist-text',
          content: 'Вот 10 типичных ловушек мышления (по Дэвиду Бёрнсу). Нажми на (?) чтобы увидеть пример.',
          delay: 1000,
        },
        {
          type: 'checklist-with-hints',
          options: {
    ...
    },
    {
      ...
      messages: [
        ...
        },
        {
          ...
          options: {
            title: 'Выбери вопрос для начала:',
            questions: [
              'Какие факты подтверждают?',
              'Какие факты опровергают?',
              'Что бы я сказал коллеге?',
              'Вероятен ли худший сценарий?',
              'Как я посмотрю через год?',
            ],
          },
          delay: 1000,
        },
